 ...
 */
KIARA.DefenseNavalArmy = function(gameState, foeEntities, sea)
{
 ...
 */
KIARA.DefenseNavalArmy.prototype.addFoe = function(gameState, enemyId, force)
{
	...
	ent.setMetadata(PlayerID, "PartOfNavalArmy", this.ID);
 ...
 */
KIARA.DefenseNavalArmy.prototype.removeFoe = function(gameState, enemyId, enemyEntity)
{
	...
	if (ent)    // TODO recompute strength when no entities (could happen if capture+destroy)
	{
		...
		ent.setMetadata(PlayerID, "PartOfNavalArmy", undefined);
	}
 ...
 */
KIARA.DefenseNavalArmy.prototype.addOwn = function(gameState, id, force)
{
...
KIARA.DefenseNavalArmy.prototype.removeOwn = function(gameState, id, Entity)
{
 ...
 */
KIARA.DefenseNavalArmy.prototype.clear = function(gameState)
{
...
KIARA.DefenseNavalArmy.prototype.assignUnit = function(gameState, entID)
{
	...
	if (idMin !== undefined)
		...
		KIARA.Logger.warn("not assigned");
		return false;
	}
...
KIARA.DefenseNavalArmy.prototype.getSea = function()
{
	return this.sea;
};

KIARA.DefenseNavalArmy.prototype.getState = function()
{
 ...
 */
KIARA.DefenseNavalArmy.prototype.merge = function(gameState, otherArmy)
{
...
KIARA.DefenseNavalArmy.prototype.needsDefenders = function(gameState)
{
	let defenseRatio;
...
KIARA.DefenseNavalArmy.prototype.recalculatePosition = function(gameState, force)
{
...
KIARA.DefenseNavalArmy.prototype.recalculateStrengths = function(gameState)
{
	this.ownStrength = 0;
	this.foeStrength = 0;
...
KIARA.DefenseNavalArmy.prototype.evaluateStrength = function(ent, isOwn, remove)
{
	if (!ent)
		return;
...
KIARA.DefenseNavalArmy.prototype.checkEvents = function(gameState, events)
{
...
KIARA.DefenseNavalArmy.prototype.update = function(gameState)
{
	for (let entId of this.ownEntities)
	{
		let ent = gameState.getEntityById(entId);
...
KIARA.DefenseNavalArmy.prototype.Serialize = function()
{
	return {
		"ID": this.ID,
		"sea": this.sea,
...
KIARA.DefenseNavalArmy.prototype.Deserialize = function(data)
{
	for (let key in data)
		this[key] = data[key];
};
